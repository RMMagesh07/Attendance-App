...
class SubjectViseAttendPage extends StatefulWidget {
  @override
  _SubjectViseAttendPageState createState() => _SubjectViseAttendPageState();
}

class _SubjectViseAttendPageState extends State<SubjectViseAttendPage> {
  int _selectedIndex = 0;
  String? _selectedSubject;
  DateTime? _selectedDate;

  List<String> subjectList = ['Subject1', 'Subject2', 'Subject3', 'Subject4', 'Subject5'];
